...
I wish that I had taken more time to really understand how the emojis' height/width properties interact with the canvas (and just generally understanding the canvas' properties more clearly).

**What challenges did you face, and how did you overcome them?**

I had some challenges with proper importation of the kilt graphics, and got help from Lewis to correctly implement them. Besides that, getting my math right to properly space the emojis was my other challenge, solved through pure trial and error.

**What is something that was interesting or exciting, or a lesson you learned
  from this experience that you want to remember?**

  I learned how to access the kilt graphics documentation, which was very useful, and got more comfortable with loops!
